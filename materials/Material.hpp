...
enum Event : int{
    ABSORTION=0, DIFFUSION=1, SPECULAR=2, REFRACTION=3
};
...
class Material{
    ...
    public:
        ...
        bool calculateRayCollision(RGB& initial, Direction rayDirection, Direction& newDirection, Point collisionPoint, Direction surfaceNormal, Direction tangent1, Direction tangent2);
